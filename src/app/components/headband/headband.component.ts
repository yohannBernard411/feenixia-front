...
export class HeadbandComponent{
  ...
  // @Input() careimg: string = '';

  careimg: string = "";

  imgbycare(care: string){
   switch (care){
      case "Les guidances":
        this.careimg = "https://i.ibb.co/3TbMNg0/cartesSM.webp";
        break;
      case "Le magnetisme":
        this.careimg = "https://i.ibb.co/px0X72D/magnetisme-SM.webp";
        break;
      case "Le néttoyage energetique":
        this.careimg = "https://i.ibb.co/C9XpD0P/purification-SM.webp";
        break;
      case "Le bien être":
        this.careimg = "https://i.ibb.co/TL2L05C/bien-etre-SM.webp";
        break;
      default :
        this.careimg = "https://i.ibb.co/TL2L05C/bien-etre-SM.webp";
      break;
